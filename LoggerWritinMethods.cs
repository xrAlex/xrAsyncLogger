...
namespace xrAsyncLogger
{
    public partial class Logger
    {
        ...
        /// </summary>
        /// <param name="msg"> Message</param>
        public void Info(string msg) => Write(msg, InfoString);
        ...
        public void Warn(string msg, Exception ex = null) => Write(msg, WarnString, ex);
        ...
        /// <param name="msg"> Message</param>
        /// /// <param name="ex"> Exception</param>
        public void Error(string msg, Exception ex = null) => Write(msg, ErrorString, ex);
        ...
        /// /// <param name="ex"> Exception</param>
        public void Fatal(string msg, Exception ex = null) => Write(msg, FatalString, ex);
